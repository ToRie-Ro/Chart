...
Registration and password login currently create a device session directly after the password is verified. Email verification is disabled for now and can be added later without changing the password or session security model.
